...
этого дисковый профиль НЕ улучшен миграцией. Практически: на VPS с 80 ГБ
стартовать с `retention_days=7` (история не теряется — уходит в
csv.gz-архив HistoryArchiver) и пересмотреть по замеру первых суток.
