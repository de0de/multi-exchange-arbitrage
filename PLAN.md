...
- [x] **Paper Trading симуляция — Фаза 1 (spot-spot) — реализовано:**
  ...
  - **Учесть частичное исполнение ордера** (реальный кейс: $100 → $27 потерь 
    из-за низкой ликвидности и двойной комиссии за перевод "застрявшего" 
    остатка) — сравнивать запрошенный объём с реально исполнимым по order book
...
- [ ] **Withdrawal fee parser (комиссии на перевод монет):**
  ...
  - Источник данных и логика самого парсера — обсудить отдельно, не решено
